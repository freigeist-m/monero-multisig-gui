        ...
        ColumnLayout {
            ...
            ListView {
                ...
                model: WalletManager.walletNames.filter(function(name) {
                    ...
                    return meta.archived;  // Only show archived
                })
                clip: true
                spacing: 8
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    AppIconButton {
                        ...
                        ToolTip.text: qsTr("Unarchive Wallet")
                        ToolTip.delay: 500
                        onClicked: {
                            if (WalletManager.setWalletArchived(name, false)) {
                            }
                        }
                    }
